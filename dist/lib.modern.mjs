...
`),t=>t.active?"rgba(255, 255, 255, 0.2)":"none"),J=i(q)(N||(N=X`
    display: block;
    margin-bottom: 5px;
`)),Q=i("div")(H||(H=X`
    display: inline-block;
